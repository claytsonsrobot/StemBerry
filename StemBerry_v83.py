...
- dev port is currently defined manually with 
...
def createBackupFile():
    ...
    filename_savestate_full = address+"/"+filename_savestate
    ...
    lines = [
        ...
        'GUI.travelvelocity.get() = '+str(GUI.travelvelocity.get()),
        'GUI.samplingrate.get() = '+str(GUI.samplingrate.get()),
...
def rename(filename): #if filename already exists - prompt user to rename
    ...
    increment_button.pack(side='top', fill='both', ipadx=10, ipady=10)
    overwrite_button.pack(side='top', fill='both', ipadx=10,ipady=10)
...
class GUI(tk.Tk):
    ...
    def initializeVarsGUI():
        ...
        GUI.passfillednames_checkbox = IntVar() #
        GUI.timestring = StringVar()
        GUI.travelvelocity = DoubleVar()
        GUI.samplingrate = DoubleVar()
        GUI.startRange1, GUI.startRange2, GUI.startRange3 = IntVar(), IntVar(), IntVar() # cm = StringVar()
        
        GUI.cell1Mass,GUI.cell2Mass,GUI.cell3Mass,GUI.cell4Mass,GUI.cell5Mass,GUI.cell6Mass,GUI.cell7Mass,GUI.cell8Mass,GUI.cell9Mass = IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar()
        GUI.cell1Count,GUI.cell2Count,GUI.cell3Count,GUI.cell4Count,GUI.cell5Count,GUI.cell6Count,GUI.cell7Count,GUI.cell8Count,GUI.cell9Count = IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar()
        GUI.cell1Diameter1,GUI.cell2Diameter1,GUI.cell3Diameter1,GUI.cell4Diameter1,GUI.cell5Diameter1,GUI.cell6Diameter1,GUI.cell7Diameter1,GUI.cell8Diameter1,GUI.cell9Diameter1 = IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar()
        GUI.cell1Diameter2,GUI.cell2Diameter2,GUI.cell3Diameter2,GUI.cell4Diameter2,GUI.cell5Diameter2,GUI.cell6Diameter2,GUI.cell7Diameter2,GUI.cell8Diameter2,GUI.cell9Diameter2 = IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar()
        GUI.cell1Diameter3,GUI.cell2Diameter3,GUI.cell3Diameter3,GUI.cell4Diameter3,GUI.cell5Diameter3,GUI.cell6Diameter3,GUI.cell7Diameter3,GUI.cell8Diameter3,GUI.cell9Diameter3 = IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar()
        GUI.cell1Diameter4,GUI.cell2Diameter4,GUI.cell3Diameter4,GUI.cell4Diameter4,GUI.cell5Diameter4,GUI.cell6Diameter4,GUI.cell7Diameter4,GUI.cell8Diameter4,GUI.cell9Diameter4 = IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar(),IntVar()
...
class InitialInputs(tk.Frame):
    ...
    def savePreTestInputs(self):
        ...
        update_filename_preTest()
        filename_preTest_csv = address + '/' + GUI.filename_preTest.get() + '.csv'
        ...
        ''' write CSV'''
        data_preTest = [variety, plot, stemheight, barbottom, barmiddle, startRange1, startRange2, startRange3]
        columns_data_preTest = zip_longest(*data_preTest)
...
class RecordForce(tk.Frame):
    def __init__(self, parent, controller):# automatically runs
        ...
        RecordForce.datafeed_frame.place(x = 20, y = 80)
    ...
    def startCollect():
        ...
        if ignoreserial == False:
            ...
            print("Data collection not run, because ignoreserial ==",str(ignoreserial),"...")
    ...
    def stopAndSave():
        if ignoreserial == False:
            ...
            print("File not saved. ignoreserial == True.")

    def saveForce():
        createBackupFile()
        # force data filename
        filename_force_csv = address + '/' + (GUI.filename_force.get()) + '.csv'
        if overwriteGuard(filename_force_csv) == True: # filename already exists, needs to be renamed
            rename(filename_force_csv) # prompt user to rename file
        ...
        GUI.travelvelocity.set(travelvelocity)
        GUI.samplingrate.set(rate) # changed from 1/rate, to avoid a divide by zero error

        RecordForce.sidehitPeakClick()
        print("Dave")
                
        if ignoreserial == False and len(GUI.forcePushed)>0:
            GUI.distanceTraveled.insert(0, "Distance(cm)")
            GUI.forcePushed.insert(0, "Force(N)")
            GUI.timeElapsed.insert(0 , "Time(ms)")

            ''' write CSV'''
            data_recordForce = [GUI.timeElapsed,GUI.distanceTraveled, GUI.forcePushed, avelocity, sampling,RecordForce.peaks_force,RecordForce.peaks_distance,RecordForce.peaks_time]
            columns_data_recordForce = zip_longest(*data_recordForce)
            ...
            print("Force data not saved. ignoreserial = "+str(ignoreserial)+". len(GUI.forcePushed) = ",len(GUI.forcePushed))
    ...
    def instantGraph(self):
        ...
        if self.checkAutoGraph.get() == 1 and len(GUI.distanceTraveled)>5 and ignoreserial == False:
            ...
            print("There is no data to graph. Try ignoreserial = False, in StemBerry.")
        '''
    def sidehitPeakClick():
        ...
        if (GUI.currentdirection.get() == "side1") or (GUI.currentdirection.get() == "side2") or (GUI.currentdirection.get() == "side3"): 
            if len(GUI.forcePushed)>0:
                ...
                RecordForce.peaks_force,RecordForce.peaks_distance,RecordForce.peaks_time = peakclick.peakclick(GUI.forcePushed,GUI.distanceTraveled,GUI.timeElapsed,varietyAndPlotnameAndDetail,address,GUI.travelvelocity.get())
    ...
    def sortClicks():
        if GUI.currentdirection.get() == "side1":
            ...
            GUI.peak_distance_cell1, GUI.peak_distance_cell2, GUI.peak_distance_cell3 = RecordForce.peaks_direction[0],RecordForce.peaks_direction[1],RecordForce.peaks_direction[2]
            ...
            GUI.peak_distance_cell4, GUI.peak_distance_cell5, GUI.peak_distance_cell6 = RecordForce.peaks_direction[0],RecordForce.peaks_direction[1],RecordForce.peaks_direction[2]
            ...
            GUI.peak_distance_cell7, GUI.peak_distance_cell8, GUI.peak_distance_cell9 = RecordForce.peaks_direction[0],RecordForce.peaks_direction[1],RecordForce.peaks_direction[2]
...
class FinalInputs(tk.Frame):
    ...
    def savePostTestInputs(self):   
        ...
        filename_postTest_csv = address + '/' + (GUI.filename_postTest.get()) + '.csv'
     
        mass1 = [GUI.cell1Mass.get()] # TypeError: 'float' object is not iterable
        mass2 = [GUI.cell2Mass.get()]
        mass3 = [GUI.cell3Mass.get()]
        mass4 = [GUI.cell4Mass.get()]
        mass5 = [GUI.cell5Mass.get()]
        mass6 = [GUI.cell6Mass.get()]
        mass7 = [GUI.cell7Mass.get()]
        mass8 = [GUI.cell8Mass.get()]
        mass9 = [GUI.cell9Mass.get()]
        count1 = [GUI.cell1Count.get()] # TypeError: 'float' object is not iterable
        count2 = [GUI.cell2Count.get()]
        count3 = [GUI.cell3Count.get()]
        count4 = [GUI.cell4Count.get()]
        count5 = [GUI.cell5Count.get()]
        count6 = [GUI.cell6Count.get()]
        count7 = [GUI.cell7Count.get()]
        count8 = [GUI.cell8Count.get()]
        count9 = [GUI.cell9Count.get()]

        diam1 = [GUI.cell1Diameter1.get(),GUI.cell1Diameter2.get(),GUI.cell1Diameter3.get(),GUI.cell1Diameter4.get()]
        diam2 = [GUI.cell2Diameter1.get(),GUI.cell2Diameter2.get(),GUI.cell2Diameter3.get(),GUI.cell2Diameter4.get()]
        diam3 = [GUI.cell3Diameter1.get(),GUI.cell3Diameter2.get(),GUI.cell3Diameter3.get(),GUI.cell3Diameter4.get()]
        diam4 = [GUI.cell4Diameter1.get(),GUI.cell4Diameter2.get(),GUI.cell4Diameter3.get(),GUI.cell4Diameter4.get()]
        diam5 = [GUI.cell5Diameter1.get(),GUI.cell5Diameter2.get(),GUI.cell5Diameter3.get(),GUI.cell5Diameter4.get()]
        diam6 = [GUI.cell6Diameter1.get(),GUI.cell6Diameter2.get(),GUI.cell6Diameter3.get(),GUI.cell6Diameter4.get()]
        diam7 = [GUI.cell7Diameter1.get(),GUI.cell7Diameter2.get(),GUI.cell7Diameter3.get(),GUI.cell7Diameter4.get()]
        diam8 = [GUI.cell8Diameter1.get(),GUI.cell8Diameter2.get(),GUI.cell8Diameter3.get(),GUI.cell8Diameter4.get()]
        diam9 = [GUI.cell9Diameter1.get(),GUI.cell9Diameter2.get(),GUI.cell9Diameter3.get(),GUI.cell9Diameter4.get()]

         # Labels for Excel
        diam1.insert(0,"diameters_cell1(mm)")
        diam2.insert(0,"diameters_cell2(mm)")
        diam3.insert(0,"diameters_cell3(mm)")
        diam4.insert(0,"diameters_cell4(mm)")
        diam5.insert(0,"diameters_cell5(mm)")
        diam6.insert(0,"diameters_cell6(mm)")
        diam7.insert(0,"diameters_cell7(mm)")
        diam8.insert(0,"diameters_cell8(mm)")
        diam9.insert(0,"diameters_cell9(mm)")
        mass1.insert(0,"mass_cell1(kg)")
        mass2.insert(0,"mass_cell2(kg)")
        mass3.insert(0,"mass_cell3(kg)")
        mass4.insert(0,"mass_cell4(kg)")
        mass5.insert(0,"mass_cell5(kg)")
        mass6.insert(0,"mass_cell6(kg)")
        mass7.insert(0,"mass_cell7(kg)")
        mass8.insert(0,"mass_cell8(kg)")
        mass9.insert(0,"mass_cell9(kg)")
        count1.insert(0,"count_cell1")
        count2.insert(0,"count_cell2")
        count3.insert(0,"count_cell3")
        count4.insert(0,"count_cell4")
        count5.insert(0,"count_cell5")
        count6.insert(0,"count_cell6")
        count7.insert(0,"count_cell7")
        count8.insert(0,"count_cell8")
        count9.insert(0,"count_cell9")
        ...
        ''' write CSV'''
        data_postTest = [diam1,diam2,diam3,diam4,diam5,diam6,diam7,diam8,diam9,mass1,mass2,mass3,mass4,mass5,mass6,mass7,mass8,mass9,count1,count2,count3,count4,count5,count6,count7,count8,count9]
        columns_data_postTest = zip_longest(*data_postTest)
    ...
    def saveEIs(self):
        ...
        ''' write CSV'''
        data_EI = [GUI.EI_fullcontact,GUI.EI_intermediatecontact,GUI.EI_nocontact,GUI.AvgEI_intermediatecontact]
        columns_data_EI = zip_longest(*data_EI)
    ...
    def compileNineCellData(self):
        ...
        if len(GUI.peaks_force) == 9:            
            ...
            GUI.EI_fullcontact, GUI.EI_nocontact, GUI.EI_intermediatecontact = [],[],[]
            for i in range(0,9):
                GUI.EI_fullcontact[i], GUI.EI_nocontact[i], GUI.EI_intermediatecontact[i] = calculateEI(GUI.peaks_force[i], GUI.stemheight.get(), GUI.barbottom.get(), GUI.stemcounts[i])
            GUI.AvgEI_intermediatecontact = np.mean(GUI.EI_intermediatecontact)
            saveEIs()
        else:
...
def choosePeaks(xData, forcePushed, xCut, varietyAndPlotnameAndDetail, encoderWorked, disReferenced, documentationFolder):
    ...
    peaks_force = [] # force peaks
    peaks_xaxis = [] # x (distance) pt of force peak
    def click(event): # get x coord once mouse is pressed
    ...
    plt.show()
    '''
    WHY DAVE WHY WILL THIS NOT PASS
    It's because the tkinter window is still showing, and the next shit doesn't happen util you close the tkinter GUI
    # EMBED THE MATPLOTLIB PLOT INTO A TKINTER WINDOW< WHICH CAB BE A POPUP< LEADING TO POPUP.MAINLOOP()
    ...
    print('peaks_xaxis = ', peaks_xaxis)
    return peaks_force, peaks_xaxis
...
class peakclick:
    ...
    def peakclick(forcePushed,distanceTraveled,timeElapsed,varietyAndPlotnameAndDetail,address,averageVelocity):
        ...
        if encoderWorked == True:
            ...
            peakclick.peaks_force,peakclick.peaks_xaxis = choosePeaks(distanceTraveled, forcePushed, xCut,varietyAndPlotnameAndDetail,encoderWorked, disReferenced_PeakClick,documentationFolder)
            ...
            peakclick.peaks_force,peakclick.peaks_xaxis = choosePeaks(disNew, forcePushed, xCut,varietyAndPlotnameAndDetail,encoderWorked, disReferenced_PeakClick, documentationFolder)
            peakclick.peaks_distance = peakclick.peaks_xaxis
            peakclick.peaks_time = peakclick.findmatchtime(forcePushed,distanceTraveled,timeElapsed,peaks_distance)
            print("peaks_force =",peakclick.peaks_force)
        else: #elif encoderWorked == False and disReferenced_PeakClick == False:
            xCut=tCut
            print('Time cut at: ', xCut)
            peakclick.peaks_force,peakclick.peaks_xaxis = choosePeaks(timeElapsed, forcePushed, xCut,varietyAndPlotnameAndDetail,encoderWorked, disReferenced_PeakClick, documentationFolder)
            peakclick.peaks_time = peakclick.peaks_xaxis
            peakclick.peaks_distance = [0, 0, 0] # might error, if there are not three clicks
            print("peaks_force =",peakclick.peaks_force)

        peakclick.saveCSV(varietyAndPlotnameAndDetail,address)
    ...
    def saveCSV(varietyAndPlotnameAndDetail,address):
        ...
        ''' write CSV'''
        data_peaks = [peakclick.peaks_force,peakclick.peaks_distance,peakclick.peaks_time]
        RecordForce.peaks_force = peakclick.peaks_force
        RecordForce.peaks_direction = peakclick.peaks_distance
        RecordForce.peaks_time = peakclick.peaks_time
        RecordForce.peaks_direction.insert(0, "PeaksDistance(cm)")
