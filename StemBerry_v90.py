...
class FinalInputs(tk.Frame):
    ...
    def saveCompiled():
        ...
        filenames_CSV_all = [filename_preTest_csv,filename_postTest_csv,filename_EI_csv,filename_forceSide1_csv,filename_forceSide2_csv,filename_forceSide3_csv,filename_forceForward_csv]
        sheetnames_XLSX_all = ['preTest','postTest','EI','force_side1','force_side2','force_side3','force_forward']
        ...
        try:
            ...
            try:
                ...
                writer.save()
                print("filename_compiled_xlsx = "+filename_compiled_xlsx)
                print("Force data not included in compilation file.")
            except:
