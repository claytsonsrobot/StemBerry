...
class peakclick:
    ...
    def peakclick(forcePushed,distanceTraveled,timeElapsed,varietyAndPlotnameAndDetail,address,averageVelocity):
        ...
        if encoderWorked == True:
            ...
            peakclick.peaks_force,peakclick.peaks_xaxis = choosePeaks(distanceTraveled, forcePushed, xCut,varietyAndPlotnameAndDetail,encoderWorked, disReferenced,documentationFolder)
            ...
            peakclick.peaks_force,peakclick.peaks_xaxis = choosePeaks(disNew, forcePushed, xCut,varietyAndPlotnameAndDetail,encoderWorked, disReferenced, documentationFolder)
            peakclick.peaks_distance = peakclick.peaks_xaxis
            peakclick.peaks_time = peakclick.findmatchtime(forcePushed,distanceTraveled,timeElapsed,peaks_distance)
            print("peaks_force =",peakclick.peaks_force)
            ...
            peakclick.peaks_force,peakclick.peaks_xaxis = choosePeaks(timeElapsed, forcePushed, xCut,varietyAndPlotnameAndDetail,encoderWorked, disReferenced, documentationFolder)
